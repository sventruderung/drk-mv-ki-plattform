...
SYSTEM_PROMPT = (
    ...
    "Eingangsrechnungen = Rechnungen VON Lieferanten/Kreditoren (Maske 'Incoming "
    "Invoice', INVOICE_*); Ausgangsrechnungen = Rechnungen AN Kunden/Debitoren "
    "(liegen in der Maske 'Sage Verkaufsbeleg', E4S_*). Bei belegdatum IMMER passend "
    "setzen; ist die Art nicht genannt, 'beide'.\n"
    ...
    "keine Tabelle).\n"
    "   • summe=true bei Geldsummen-Fragen ('Gesamtsumme/Summe/wie hoch ist der "
    "Betrag …'): das Ergebnis enthält dann 'summe' (in EUR).\n"
    "   • felder={FELD:WERT}: Filter über echte Feldnamen. Wird ein Lieferant/Kunde "
    "oder ein anderer Wert GENANNT, MUSS er hier stehen — AUCH zusammen mit liste=true "
    "(liste steuert nur Tabelle-vs-Zahl, NIE die Filter). Lieferantenname → "
    "VENDOR_NAME (NICHT VENDOR_NO = Kreditorennummer); Kundenname → E4S_KUNDEN_NAME. "
    "Textwerte dürfen '*' enthalten.\n"
    ...
    "felder={\"VENDOR_NAME\":\"Y\"}; "
    "'Eingangsrechnungen von ADN aus 2026 auflisten' → belegdatum='2026', "
    "rechnungsart='eingang', felder={\"VENDOR_NAME\":\"ADN\"}, liste=true; "
    "'Ausgangsrechnungen an Kunde X' → "
    ...
    "Satz, KEINE Tabelle). Bei SUMMENFRAGEN nenne den Wert aus 'summe' in EUR (ein "
