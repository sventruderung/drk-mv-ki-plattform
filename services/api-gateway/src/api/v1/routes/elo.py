...
SYSTEM_PROMPT = (
    ...
    "Beispiele. Parameter:\n"
    "   • belegdatum='JJJJMM' (Monat) oder 'JJJJ' (Jahr): zählt das Rechnungs-/"
    "Belegdatum über BEIDE Rechnungsarten zusammen. Nur nutzen, wenn NICHT nach einer "
    "bestimmten Art gefragt ist ('Rechnungen/Belege aus Juni 2026').\n"
    "   • felder={FELD:WERT}: Filter über echte Feldnamen (s.o.). Textwerte dürfen "
    "'*' als Platzhalter nutzen.\n"
    "   WICHTIG für EINE bestimmte Rechnungsart im Zeitraum: NICHT belegdatum, sondern "
    "das maskeneigene Datumsfeld als Wildcard in felder — 'Eingangsrechnungen im "
    "Monat' → felder={\"INVOICE_DATE\":\"JJJJMM*\"}; 'Ausgangsrechnungen im Monat' → "
    "felder={\"E4S_BELEG_DATE\":\"JJJJMM*\"}.\n"
    ...
    "Beispiele: 'Rechnungen/Belege aus Juni 2026' (beide) → belegdatum='202606'; "
    "'Eingangsrechnungen aus Juni 2026' → felder={\"INVOICE_DATE\":\"202606*\"}; "
    "'Ausgangsrechnungen aus Juni 2026' → felder={\"E4S_BELEG_DATE\":\"202606*\"}; "
